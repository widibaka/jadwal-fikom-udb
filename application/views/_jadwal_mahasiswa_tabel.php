    ...
    <nav class="navbar navbar-expand-md fixed-top navbar-dark bg-dark">
      ...
      <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url('jadwal/jurusan/') . $jurusan . "/" ?>">Pilih Kelas</a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url('jadwal/jadwal_tabel/') . $jurusan . "/" . $kelas ?>">Jadwal Tabel <span class="badge badge-danger">New</span></a>
          </li>
        </ul>
      </div>
    </nav>
                ...
                <?php foreach ($hari as $key => $value_hari): 
                  ...
                  <?php if ( $jadwal_tunggal ): ?>
                    <td class="data_jadwal <?php 
                      ...
                      <span class="dosen d-none"><a title="Buka jadwal milik <?php echo $jadwal_tunggal['dosen'] ?>" href="<?php echo base_url('jadwal/dosen/') . str_replace('/', 'garis_miring', base64_encode($jadwal_tunggal['dosen'])) ?>"><?php echo $jadwal_tunggal['dosen'] ?></a></span>
