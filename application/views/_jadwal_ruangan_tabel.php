  ...
  <body class="bg-light">
    ...
    <nav class="navbar navbar-expand-md fixed-top navbar-dark bg-dark">
      ...
      <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url('jadwal/ruangan/') . '1/QXVsYSAx' ?>">Tampilan Utama</a>
          </li>
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              Jadwal Tabel <?php echo $hari0 ?> <span class="badge badge-danger">New</span>
            </a>
    ...
    <main role="main" class="">
      <div class="my-3 p-3 bg-white rounded box-shadow table-responsive">
        ...
        <table class="table table-bordered text-dark table-sm table-striped" id="tabel-jadwal" style="border-color: #000000">
          ...
          <thead class="table-dark">
            <tr>
              ...
              <?php foreach ($ruangan0['ruangan'] as $key => $value): ?>
                <th data-width="80" scope="col"><?php echo $value ?></th>
              <?php endforeach ?>
            </tr>
          </thead>
          <tbody id="myTB">
            ...
            <?php foreach ($jam as $key => $value_jam): ?>
              <tr>
                ...
                <?php foreach ($ruangan0['ruangan'] as $key => $value_ruangan): 
                  ...
                  <?php //var_dump($jadwal_tunggal); die(); ?>
                  
                  <?php if ( $jadwal_tunggal ): ?>
                    <td style="background-color: <?php if(!empty($jadwal_tunggal['warna_dosen'])){echo $jadwal_tunggal['warna_dosen'];} ?>" class="data_jadwal <?php 
                      ...
                      <span class="hari d-none"><?php echo $jadwal_tunggal['hari'] ?></span>
                  ...
                  <?php else: ?>
                    <td class="data_jadwal" id="td-111<?php echo $hari0 . $value_jam['id'] ?>" <?php 
                      if ( !empty( $this->session->userdata('admin') ) ) {
                        echo 'onclick="add_jadwal(111' . $hari0 . $value_jam['id'] . ')"  data-toggle="modal" data-target="#exampleModalLong"';
                      }
                    ?>>
                      <span class="hari d-none"><?php echo $$hari0 ?></span>
